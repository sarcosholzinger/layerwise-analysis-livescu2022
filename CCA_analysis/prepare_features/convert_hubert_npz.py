...
def convert_npz_to_npy(
    ...
    """
    Convert all HuBERT NPZ files to layer-wise NPY format.
    This script processes all NPZ files while keeping all features.
...
if __name__ == "__main__":
    ...
    output_dir = "/home/hltcoe/sholzinger/phd/git/layerwise-analysis-cca-vis/CCA_analysis/prepare_features/converted_features/hubert_complete"
